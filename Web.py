...
# Title
st.title('Prediksi Kelayakan Halal Pada Produk Bakeri')
session_state = st.session_state

def Analisa():
    st.header('Prediksi Kecepatan Penerbitan Sertifikat Halal')
# Elemen antarmuka pengguna untuk input
Produk = st.text_input('Masukan Produk')
Bahan1 = st.number_input('Masukkan Bahan1', min_value=0, max_value=2, value=0, step=0)
Bahan2 = st.number_input('Masukkan Bahan2', min_value=0, max_value=2, value=0, step=0)
Bahan3 = st.number_input('Masukkan Bahan3', min_value=0, max_value=2, value=0, step=0)
Bahan4 = st.number_input('Masukkan Bahan4', min_value=0, max_value=2, value=0, step=0)
Bahan5 = st.number_input('Masukkan Bahan5', min_value=0, max_value=2, value=0, step=0)
Bahan6 = st.number_input('Masukkan Bahan6', min_value=0, max_value=2, value=0, step=0)
Bahan7 = st.number_input('Masukkan Bahan7', min_value=0, max_value=2, value=0, step=0)
Bahan8 = st.number_input('Masukkan Bahan8', min_value=0, max_value=2, value=0, step=0)
Bahan9 = st.number_input('Masukkan Bahan9', min_value=0, max_value=2, value=0, step=0)
...
def Plot():
        ...
        data_to_plot = {
            'Bahan1': session_state.input_data_beranda[0],
            'Bahan2': session_state.input_data_beranda[1],
            'Bahan3': session_state.input_data_beranda[2],
            'Bahan4': session_state.input_data_beranda[3],
            'Bahan5': session_state.input_data_beranda[4],
            'Bahan6': session_state.input_data_beranda[5],
            'Bahan7': session_state.input_data_beranda[6],
            'Bahan8': session_state.input_data_beranda[7],
            'Bahan9': session_state.input_data_beranda[8],
        }
